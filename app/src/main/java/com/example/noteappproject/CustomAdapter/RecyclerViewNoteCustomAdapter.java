...
public class RecyclerViewNoteCustomAdapter extends RecyclerView.Adapter<RecyclerViewNoteCustomAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public RecyclerViewNoteCustomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewNoteCustomAdapter.ViewHolder holder, int position) {
